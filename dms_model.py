...
#   Signals
    ...
    def choose_next_trial(self):
        move = False
        if self.trial_type_progress[1] >= self.strict_ub or self.trial_type_progress[0] >= self.hi_bounds[self.trial_type]:
            move = True
    ...
    def run_program(self):
        ...
        while self.run:
            ...
            events += [perfect] + result + [early] + lick + times + [self.give_water] + self.hi_bounds.tolist() + self.low_bounds.tolist()
