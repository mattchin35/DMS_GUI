...
class Ui_trainingWindow:
    def __init__(self, MainWindow, opts):
...
#   BUTTONS
        ...
        self.upper3Button = QtWidgets.QPushButton(self.controlsGroup)
        self.upper3Button.setGeometry(QtCore.QRect(5, 260, 31, 21))
        self.upper3Button.setObjectName("upper3Button")

        self.upper1Button = QtWidgets.QPushButton(self.controlsGroup)
        self.upper1Button.setGeometry(QtCore.QRect(5, 290, 31, 21))
        self.upper1Button.setObjectName("upper1Button")

        self.lower3Button = QtWidgets.QPushButton(self.controlsGroup)
        self.lower3Button.setGeometry(QtCore.QRect(5, 320, 31, 21))
        self.lower3Button.setObjectName("lower3Button")

        self.lower1Button = QtWidgets.QPushButton(self.controlsGroup)
        self.lower1Button.setGeometry(QtCore.QRect(5, 350, 31, 21))
...
#   COMBO BOX/DROP DOWN LISTS
        ...
        self.odorTypeComboBox = QtWidgets.QComboBox(self.centralwidget)
        self.odorTypeComboBox.setGeometry(QtCore.QRect(300, 20, 91, 31))
        self.odorTypeComboBox.setObjectName("odorTypeComboBox")
        self.odorTypeComboBox.addItem("")
        self.odorTypeComboBox.addItem("")
...
#   SET TEXTS
    ...
    def setOdorLabels(self):
        _translate = QtCore.QCoreApplication.translate
        if self.opts.cd_ab:
            self.aaProbabilityLabel.setText(_translate("MainWindow", "CA"))
            self.abProbabilityLabel.setText(_translate("MainWindow", "CB"))
            self.bbProbabilityLabel.setText(_translate("MainWindow", "DB"))
            self.baProbabilityLabel.setText(_translate("MainWindow", "DA"))
...
if __name__ == "__main__":
    ...
    ui = Ui_trainingWindow(MainWindow, opts)
    ui.mainWindow.show()
    sys.exit(app.exec_())
