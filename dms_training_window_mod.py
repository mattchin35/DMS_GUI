...
class Ui_trainingWindow:
    ...
    #   #   Graphics & Widgets
        ...
        self.trialByTrialGraphic_2 = QtWidgets.QLabel(self.currentStatusGroup)
        self.trialByTrialGraphic_2.setGeometry(QtCore.QRect(170, 140, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        self.trialByTrialGraphic_2.setFont(font)
        self.trialByTrialGraphic_2.setObjectName("trialByTrialGraphic_2")

        self.correctGraphic = QtWidgets.QLabel(self.currentStatusGroup)
        self.correctGraphic.setGeometry(QtCore.QRect(220, 410, 68, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        self.correctGraphic.setFont(font)
        self.correctGraphic.setObjectName("correctGraphic")

        self.biasGraphic_2 = QtWidgets.QLabel(self.currentStatusGroup)
        self.biasGraphic_2.setGeometry(QtCore.QRect(240, 660, 68, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        self.biasGraphic_2.setFont(font)
        self.biasGraphic_2.setObjectName("biasGraphic_2")
...
#QtWidgets.QTableView
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.trialByTrialGraphic_2.setText(_translate("MainWindow", "Trial-by-Trial Performance"))
        self.correctGraphic.setText(_translate("MainWindow", "Correct %"))
        self.biasGraphic_2.setText(_translate("MainWindow", "Bias"))
